package cn.lige2333.aliserver.controller;

import cn.lige2333.aliserver.Entity.Payment;
import cn.lige2333.aliserver.config.AlipayConfig;
import cn.lige2333.aliserver.service.PaymentService;
...
public class PayController {
	...
	*/
    ...
    public String updateStatus(String id){
        paymentService.updateStateById(id,1);
        return "success";
    }
    ...
    public String refund(HttpServletRequest request) throws UnsupportedEncodingException, AlipayApiException {
        ...
        String refund_amount = new String(request.getParameter("totalAmount").getBytes("ISO-8859-1"),"UTF-8");
        ...
        JSONObject outer = JSON.parseObject(result);
        JSONObject alipay_trade_refund_response = (JSONObject) outer.get("alipay_trade_refund_response");
        String msg = alipay_trade_refund_response.getString("msg");
        if(msg.equals("Success")){
            paymentService.updateStateById(out_trade_no,2);
            return "success";
        }else {
            //输出
            return "failed";
